...
from HARRYMUSIC import app, Userbot
...
async def strcall(client, message):
    assistant = await group_assistant(HARRY, message.chat.id)
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("./HARRYMUSIC/assets/call.mp3"), stream_type=StreamType().pulse_stream)
