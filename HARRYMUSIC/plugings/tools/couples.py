...
#BOT FILE NAME
from HARRYMUSIC import app as app
from HARRYMUSIC.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="𓊈𒆜彡[𝙷𝙰𝚁𝚁𝚈 ]彡𒆜𓊉",
            url=f"https://t.me/harrysfeel",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "HARRYMUSIC/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "HARRYMUSIC/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("HARRYMUSIC/assets/cppic.png")
