...
from HARRYMUSIC.core.userbot import *
...
BOT_LIST = ["JANAVI_MUSIC_BOT", "ll_RADHA_MUSICBOT", "KHUSHI_MUSIC76_BOT", "STAR_MUSICAL_BOT", "QUEEN_MUSIC_ROBOT"]
