...
from HARRYMUSIC.utils import AdminRightsCheck
from HARRYMUSIC.utils.database import is_active_chat, is_nonadmin_chat
from HARRYMUSIC.utils.decorators.language import languageCB
from HARRYMUSIC.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    mystic = await CallbackQuery.edit_message_text(
        text=_["admin_32"].format(/,
    )
    try:
        await HARRY.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
